# Adopted from https://github.com/aws-samples/step-functions-ruby-activity-worker.
#
    ...
    class PollerWorker < Worker
      ...
      def run
        activity_task = StepFunctions.with_retries(max_retry: @max_retry) do
          begin
            @logger.info("Starting long-poll for activities...")
        ...
        return if activity_task.nil? || activity_task == true || activity_task.task_token.nil?
